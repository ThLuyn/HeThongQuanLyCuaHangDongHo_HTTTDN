...
INSERT INTO `TAIKHOAN` (`MNV`, `TDN`, `MK`, `MNQ`, `TRANGTHAI`, `OTP`) VALUES 
    ...
    (2, 'nhanvien02', '$2b$12$VzUsF3R18.uyNHYjXj8vFuY3yvo3K1SNjpv1elZieWLYo80y7vOjy', 2, 1, NULL),
    (3, 'nhanvien03', '$2b$12$Br9kbXk2zEprVm3eWH8jOOYbpcRgPkpozWgZ4Ez2S9COcY4g8F/d.', 3, 1, NULL),
    (4, 'nhanvien04', '$2b$12$ksjWwF6TN51h3gzrba5CtODJ2FxZz05isFjXzN0XbJEYUsBx4P3vi', 4, 0, NULL);
...
(18, 1, 0, '2026-03-02', '2026-03-02', NULL, 'Nghỉ phép định kỳ', NULL, 0, NULL, '2026-02-28', ''), -- Trạng thái 0 = Chờ duyệt
...
-- ============================================================
  ...
  (38, 2, 11, 2024, 7000000, 26.0, 20500000, 2.0, 410000.0, 560000.0, 105000.0, 70000.0, 0, 6675000.0, 2),
